...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  hadc1.Init.Overrun = ADC_OVR_DATA_OVERWRITTEN; /* continuous free-run: always want latest sample */
  ...
  */
  ...
  sConfig.SamplingTime = ADC_SAMPLETIME_92CYCLES_5; /* AS5600 OUT: increase for output impedance */
